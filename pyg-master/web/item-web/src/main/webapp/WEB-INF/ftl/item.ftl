    ...
    <#--图片列表 -->
        ...
        <div class="product-info">
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="news"><span><#if goods.caption??>${goods.caption}<#else>暂无副标题 </#if></span></div>
                <div class="summary">
                            ...
                            <dl>
                                ...
                                <#list s.attributeValue as item>
                                    <dd><a href="javascript:;"
                                           ...
                                           ng-click="selectSpec('${s.attributeName}','${item}')">${item}</a></dd>
                                </#list>
                            </dl>
                        </#list>
                    </div>
                    ...
                    <div class="summary-wrap">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <input autocomplete="off" type="text"
                                           ng-model="num" minnum="1" class="itxt"/>
                                    <a href="javascript:void(0)" class="increment plus"
                                       ng-click="changeNum(1)">+</a>
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                <#--<a href="http://cart.pinyougou.com/cart.html" target="_blank"-->
