/** 定义订单控制器 */
app.controller("seckillOrderController", function ($scope, $controller, $interval, $location, baseService) {
    ...
    $scope.genPayCode = function () {
        baseService.sendGet("/seckillOrder/genPayCode").then(function (response) {
            if (response.data) {
                /** 获取金额 */
                ...
                var timer = $interval(function () {
                    /** 发送请求，查询支付状态 */
                    baseService.sendGet("/seckillOrder/queryPayStatus?outTradeNo="
                        + $scope.outTradeNo)
