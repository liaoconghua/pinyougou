package com.pinyougou.cart.controller.barcode;
...
public class BarCodeController {
    ...
    public void execute(@RequestParam(value = "url", required = false) String url,
        ...
        if (url == null || "".equals(url)) {
            url = "https://qr.alipay.com/a6x00075q0wzxrsohg3or23";
        }
        ...
        /** 获取公司logo图片 */
        BufferedImage logo = ImageIO.read(new File("C:/Users/Fa/Pictures/jihui.jpg"));
        /** 获取缓冲流图片的画笔 */
